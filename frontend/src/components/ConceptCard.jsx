...
const ConceptCard = ({ concept, domain }) => {
  return (
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 border border-gray-200 dark:border-gray-700">
      <div className="p-6">
        ...
        <p className="text-gray-600 dark:text-gray-400 mb-6 line-clamp-3">{concept.description}</p>
        <Link
