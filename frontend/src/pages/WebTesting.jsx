...
const test = {
  ...
  sections: {
    ...
    unit: {
      ...
      industry_applications: ["🧪 Functions","🧰 Utils","🧭 Reducers","🧱 Components"],
      advantages: ["⚡ Fast","🧭 Local","🧰 Focused","🧑‍🔧 Debuggable"],
      disadvantages: ["🧩 Mock brittleness","🧪 Gaps","🧱 Overfitting","🔧 Maintenance"],
    },
    integration: {
      concept:
      ...
      industry_applications: ["🧩 Modules","🔗 Boundaries","📡 Data","🧭 Flows"],
      advantages: ["🧭 Realistic","🧪 Catch regressions","🧰 Confidence","🧑‍🔧 Valuable"],
      disadvantages: ["🐢 Slower","🧩 Flaky","🔧 Setup","🧱 Infra"],
    },
    e2e: {
      concept:
      ...
      industry_applications: ["🛒 Checkout","🔑 Auth","🧭 Happy paths","🧪 Smoke"],
      advantages: ["🧑‍💻 User-level","🧭 Confidence","🧰 Realistic","🧪 Catch issues"],
      disadvantages: ["🐢 Slow","🧩 Flaky","🔧 CI cost","🧱 Maintenance"],
    },
    code_examples: {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-50 dark:from-gray-900 dark:via-blue-900/20 dark:to-indigo-900/20 text-gray-900 dark:text-white">
      ...
      <main className="max-w-7xl mx-auto px-6 py-12 space-y-16">
        <section><h2 className="text-4xl font-bold mb-6 text-center bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">🎯 Why Testing?</h2><div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-2xl border-l-8 border-blue-500"><p className="text-xl leading-relaxed text-gray-700 dark:text-gray-200 italic">{sections.student_hook}</p></div></section>
      ...
      <footer className="bg-gradient-to-r from-gray-800 to-gray-900 text-white py-12 mt-16"><div className="max-w-7xl mx-auto px-6 text-center"><h3 className="text-2xl font-bold mb-4">Test with confidence ✅</h3><p className="text-lg text-gray-300 mb-6">Balance unit, integration, and E2E for speed and safety.</p></div></footer>
    </div>
  );
}
