...
const dv = {
  ...
  category: "CI/CD • Docker • Kubernetes • Serverless",
  sections: {
    student_hook:
    ...
    cicd: {
      ...
      industry_applications: ["🔁 Pipelines","🧪 Test gates","🧭 Envs","🚀 Releases"],
      advantages: ["⚡ Speed","🧪 Quality","🔁 Consistency","🧭 Audit"],
      disadvantages: ["🔧 Setup","🧱 Secrets","🧩 Flaky tests","🧪 Infra cost"],
    },
    containers: {
      concept:
      ...
      industry_applications: ["🐳 Docker","☸️ K8s","🧱 IaC","🧭 Helm"],
      advantages: ["📦 Portability","📈 Scalability","🧰 Ecosystem","🧭 Observability"],
      disadvantages: ["🧩 Complexity","🧱 Learning curve","🧪 Yaml drift","🔧 Costs"],
    },
    serverless: {
      concept:
      ...
      industry_applications: ["⚡ Edge","🔔 Events","🧾 Jobs","🧭 APIs"],
      advantages: ["💸 Cost","⚡ Latency","🧭 Scale","🧰 Maintenance"],
      disadvantages: ["🔧 Cold starts","🧪 Limits","🧱 Vendor lock-in","🧩 Debugging"],
    },
    code_examples: {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-50 dark:from-gray-900 dark:via-blue-900/20 dark:to-indigo-900/20 text-gray-900 dark:text-white">
      ...
      <main className="max-w-7xl mx-auto px-6 py-12 space-y-16">
        <section><h2 className="text-4xl font-bold mb-6 text-center bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">🎯 Why DevOps?</h2><div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-2xl border-l-8 border-blue-500"><p className="text-xl leading-relaxed text-gray-700 dark:text-gray-200 italic">{sections.student_hook}</p></div></section>
      ...
      <footer className="bg-gradient-to-r from-gray-800 to-gray-900 text-white py-12 mt-16"><div className="max-w-7xl mx-auto px-6 text-center"><h3 className="text-2xl font-bold mb-4">Ship reliably 🚀</h3><p className="text-lg text-gray-300 mb-6">Automate, observe, and iterate safely.</p></div></footer>
    </div>
  );
}
